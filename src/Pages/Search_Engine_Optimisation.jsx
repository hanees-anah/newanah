  ...
  return (
    <div ref={containerRef} style={{ background: "var(--clr-bg)", overflow: "hidden" }}>
      ...
      <style>{`
                ...
                .svc-v2-hero::before {
                    content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 50% 100%, rgba(229, 179, 187, 0.15), transparent 70%);
                }
                .hero-content {
                ...
                .intro-bento:hover { border-color: rgba(229, 179, 187, 0.4);  transform: translateY(-4px) scale(1.02);  }
                ...
                .feature-bento:hover { border-color: rgba(229, 179, 187, 0.4); transform: translateY(-5px); box-shadow: var(--shadow-lg); background: var(--clr-surface); }
                .feature-bento::before {
                    content: ''; position: absolute; top: -50px; right: -50px; width: 150px; height: 150px; background: rgba(229, 179, 187, 0.2); filter: blur(40px); border-radius: 50%; z-index: 0;
                }
                ...
                .feature-icon-wrap img { width: 100%; height: 100%; object-fit: cover; transition: 0.5s; background: rgba(229, 179, 187, 0.05); }
  ...
  @media (max-width: 768px) { .intro-image-stack { width: 100%; display: flex; justify-content: center; align-items: center; } .img-primary { width: 80%; max-width: 300px; border-radius: 18px; overflow: hidden; margin: 0 auto; /* IMPORTANT backup centering */ } .img-primary img { width: 100%; height: auto; display: block; } }
      ...
      <section className="svc-v2-hero">
        <motion.div className="hero-content" style={{ y: yHeroText, opacity: opacityHeroText }}>
          ...
          <h1>Engine <span>Optimisation</span></h1>
          <p style={{ color: "var(--clr-text-secondary)", fontSize: "1.1rem", lineHeight: "1.7", maxWidth: "600px", margin: "1.5rem auto 0" }}>
            Rank higher, attract quality traffic, and grow online with expert SEO strategies designed for absolute dominance.
          </p>
        </motion.div>
      </section>
        ...
        <div className="intro-grid">
          ...
          <MagneticTilt className="intro-bento">
            ...
            <a href="/contact-us" className="ds-btn-primary" style={{ alignSelf: "flex-start", marginTop: "1rem" }}>
              Get Your SEO Audit <i className="fa-solid fa-arrow-right" />
            </a>
          </MagneticTilt>
        </div>
      </section>
        ...
        <div className="details-grid">
          <MagneticTilt className="feature-bento">
            ...
            <div className="feature-icon-wrap" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={seo3} alt="Keyword Research" style={{ objectFit: 'contain' }} />
            </div>
            <h3>Deep Keyword Architecture</h3>
            <p>Successful SEO starts with mapping psychological intent. We execute rigorous keyword research protocols to identify high-converting semantic clusters. By leveraging search trends and aggressive competitor espionage, we secure the most profitable terms.</p>
          </MagneticTilt>

          <MagneticTilt className="feature-bento">
            <div className="ds-section-tag" style={{ alignSelf: "flex-start" }}>Phase 2</div>
            <div className="feature-icon-wrap" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={seo4} alt="Technical SEO" style={{ objectFit: 'contain' }} />
            </div>
            <h3>Technical Code Optimization</h3>
            <p>A flawless technical skeleton is non-negotiable. We reconstruct your website's DOM structure, deploying ultra-fast load times and seamless crawler pathways. We eliminate indexation barriers and implement optimizations that drastically explode performance.</p>
          </MagneticTilt>
        </div>
      </section>
