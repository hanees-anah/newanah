  ...
  return (
    <div ref={containerRef} style={{ background: "var(--clr-bg)", overflow: "hidden" }}>
      ...
      <style>{`
                ...
                .svc-v2-hero::before {
                    content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 50% 100%, rgba(163, 196, 188, 0.15), transparent 70%);
                }
                .hero-content {
                ...
                .intro-bento:hover {  transform: translateY(-4px) scale(1.02);  }
                ...
                .feature-bento:hover { border-color: rgba(163, 196, 188, 0.4); transform: translateY(-5px); box-shadow: var(--shadow-lg); background: var(--clr-surface); }
                .feature-bento::before {
                    content: ''; position: absolute; top: -50px; right: -50px; width: 150px; height: 150px; background: rgba(163, 196, 188, 0.2); filter: blur(40px); border-radius: 50%; z-index: 0;
                }
                ...
                .feature-icon-wrap img { width: 100%; height: 100%; object-fit: cover; transition: 0.5s; background: rgba(163, 196, 188, 0.05); }
      ...
      <section className="svc-v2-hero">
        <motion.div className="hero-content" style={{ y: yHeroText, opacity: opacityHeroText }}>
          ...
          <p style={{ color: "var(--clr-text-secondary)", fontSize: "1.1rem", lineHeight: "1.7", maxWidth: "600px", margin: "1.5rem auto 0" }}>
            Unlock your business's potential with high-impact, conversion-focused Google Ads campaigns designed by India's best PPC agency.
          </p>
        </motion.div>
      </section>
        ...
        <div className="intro-grid">
          <MagneticTilt className="intro-image-stack">
            <div className="img-primary">
              <img src={googleAds1} alt="Google Ads Impact" />
            </div>
          </MagneticTilt>

          <MagneticTilt className="intro-bento">
            <div className="ds-section-tag" style={{ alignSelf: "flex-start" }}>Targeted ROI</div>
            <h2>Result-Driven Google Ads</h2>
            <p>
              Maximize your brand's reach with precision-targeted Google Ads. We create data-driven campaigns that put your business in front of the right audience at the exact right moment.
            </p>
            <p>
              From search to display and shopping campaigns, we establish digital supremacy. With continuous optimization and rigorous algorithmic adjustments, we ensure your ad spend delivers explosive, scalable returns.
            </p>
        ...
        <div className="details-grid">
          <MagneticTilt className="feature-bento">
            ...
            <div className="feature-icon-wrap" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={googleAds3} alt="Google Ads Strategy" style={{ objectFit: 'contain' }} />
            </div>
            <h3>Deep-Target Keyword Parsing</h3>
            <p>Our experts meticulously conduct in-depth keyword analysis to capture high-intent search traffic. By leveraging advanced segmentation and competitor reconnaissance, we isolate extremely profitable search clusters. Smart bidding drives conversions with surgical precision.</p>
          </MagneticTilt>

          <MagneticTilt className="feature-bento">
            <div className="ds-section-tag" style={{ alignSelf: "flex-start" }}>Phase 2</div>
            <div className="feature-icon-wrap" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={googleAds4} alt="Campaign Optimization" style={{ objectFit: 'contain' }} />
            </div>
            <h3>Continuous Optimization Engine</h3>
            <p>A campaign isn't launched—it's weaponized. We synthesize real-time performance data to execute aggressive A/B testing and algorithmic re-alignment. Every micro-adjustment drives cost per acquisition down, massively inflating ROAS.</p>
          </MagneticTilt>
        </div>
      </section>
